...
export default function Login(){
    ...
    return(
        <div className='flex-1 flex justify-center items-center h-screen py-10 px-4 lg:px-0'>
            <div className='px-4 lg:px-0 lg:w-4/12'>
                <h1 className='font-bold text-center text-4xl'>ACCESO RESTRINGIDO</h1>
                ...
                <Link href={"/"}>
                    <button className='bg-gray-200 py-3 mt-2 w-full text-sm'>Volver</button>
                </Link>
            </div>
        </div>
    );
