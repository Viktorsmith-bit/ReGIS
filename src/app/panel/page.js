...
export default function Login(){
    ...
    async function Login(e){
        e.preventDefault();
        if(cor === process.env.NEXT_PUBLIC_user1 || cor === process.env.NEXT_PUBLIC_user2 || cor === process.env.NEXT_PUBLIC_user3 || cor === process.env.NEXT_PUBLIC_user4){
            await signInWithEmailAndPassword(auth, cor, con).then((userCredential) => {
