    ...
    return(
        <div className='w-full lg:flex-1 mt-2'>
            <div className='flex items-center border border-gray-300'>
                <input value={props.password} onChange={props.captarCambiosPassword} type={`${vis?'password':'text'}`} className='focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 input text-xs w-full h-10 px-2' placeholder='' />
                {
